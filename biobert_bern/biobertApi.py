...
# %% auto 0
__all__ = ['blocks', 'create_com_with_idx', 'make_5k_sections', 'create_text_block', 'create_all_text_blocks',
           'get_comment_spans_textblock', 'query_plain']
...
def create_all_text_blocks(df):
    ...
    for o in df.section.unique():
        ...
        blocks = blocks.append(text_block)
    return blocks

blocks =  create_all_text_blocks(coms)
